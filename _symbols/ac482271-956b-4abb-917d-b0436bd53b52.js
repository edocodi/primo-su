...
function create_each_block_2(ctx) {
	...
	let if_block1 = /*hasDropdown*/ ctx[8] && create_if_block_2(ctx);
...
function create_fragment$1(ctx) {
	...
	icon = new Component({ props: { icon: "eva:menu-outline" } });
	...
	return {
		...
		h() {
			...
			attr(div, "class", "menu-icon svelte-138qntj");
			attr(button, "id", "open");
			attr(button, "class", "svelte-138qntj");
			attr(nav_1, "class", "svelte-138qntj");
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('banner' in $$props) $$invalidate(5, banner = $$props.banner);
	};

	return [nav, logo, mobileNavOpen, toggleMobileNav, props, banner];
}

class Component$1 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { props: 4, nav: 0, logo: 1, banner: 5 });
	}
}
