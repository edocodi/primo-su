// Testimonials 1 - Updated August 18, 2023
function noop() { }
const identity = x => x;
...
function create_key_block(ctx) {
	...
	let div2_intro;
	let current;
	icon = new Component({ props: { icon: "fa6-solid:quote-right" } });
...
function create_if_block$1(ctx) {
	...
	let mounted;
	let dispose;
	icon0 = new Component({ props: { icon: "charm:chevron-left" } });
	icon1 = new Component({ props: { icon: "charm:chevron-right" } });
...
class Component$1 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { props: 6, heading: 0, testimonials: 1 });
	}
}
