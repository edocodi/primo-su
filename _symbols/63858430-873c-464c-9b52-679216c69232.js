// Featured Quote - Updated August 18, 2023
function noop() { }
...
function create_fragment$1(ctx) {
	...
	let stop1;
	let current;
	icon = new Component({ props: { icon: "fa:quote-left" } });
	let if_block = /*image*/ ctx[1].url && create_if_block$1(ctx);
...
class Component$1 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { props: 3, name: 0, image: 1, quote: 2 });
	}
}
