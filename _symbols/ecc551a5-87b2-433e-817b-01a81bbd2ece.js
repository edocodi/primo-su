...
function get_each_context_3(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[9] = list[i].link;
	child_ctx[15] = list[i].links;
	const constants_0 = /*links*/ child_ctx[15].length > 0;
...
function create_if_block_3(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if ((!current || dirty & /*site_nav*/ 4) && t0_value !== (t0_value = /*link*/ ctx[9].label + "")) set_data(t0, t0_value);
		},
		i(local) {
			if (current) return;
...
// (178:12) {#if hasDropdown}
function create_if_block_2(ctx) {
	let div;
	let each_value_4 = /*links*/ ctx[15];
	let each_blocks = [];
...
// (164:8) {#each site_nav as { link, links }}
function create_each_block_3(ctx) {
	...
	function select_block_type_1(ctx, dirty) {
		if (/*hasDropdown*/ ctx[16]) return 0;
		return 1;
	}

	current_block_type_index = select_block_type_1(ctx);
	if_block0 = if_blocks[current_block_type_index] = if_block_creators[current_block_type_index](ctx);
	let if_block1 = /*hasDropdown*/ ctx[16] && create_if_block_2(ctx);
...
function create_each_block_2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*cta*/ 1 && t_value !== (t_value = /*link*/ ctx[9].label + "")) set_data(t, t_value);

			if (dirty & /*cta*/ 1 && a_href_value !== (a_href_value = /*link*/ ctx[9].url)) {
				attr(a, "href", a_href_value);
			}
		},
		d(detaching) {
...
function create_if_block$1(ctx) {
	...
	function select_block_type_2(ctx, dirty) {
		if (/*logo*/ ctx[1].image.url) return create_if_block_1$1;
	...
	icon = new Component({ props: { icon: "ph:x-duotone" } });
...
function create_fragment$1(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*logo*/ ctx[1].image.url) return create_if_block_4;
	...
	icon = new Component({ props: { icon: "ic:round-menu" } });
