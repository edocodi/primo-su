// Navigation 1 - Updated August 18, 2023
function noop() { }
const identity = x => x;
...
function create_if_block$1(ctx) {
	...
	icon = new Component({ props: { height: "25", icon: "bi:x-lg" } });
...
class Component$1 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { props: 3, logo: 0, site_nav: 1 });
	}
}
