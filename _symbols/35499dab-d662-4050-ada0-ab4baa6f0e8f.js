// Contact Form - Updated August 18, 2023
function noop() { }
const identity = x => x;
...
function create_fragment$1(ctx) {
	...
	let if_block;
	let current;
	const if_block_creators = [create_if_block$1, create_if_block_2, create_if_block_3];
	const if_blocks = [];
...
class Component$1 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { props: 6, form: 0, heading: 1 });
	}
}
