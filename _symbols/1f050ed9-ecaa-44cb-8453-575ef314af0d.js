// Accordion - Updated August 18, 2023
function noop() { }
const identity = x => x;
...
function create_each_block(key_1, ctx) {
	...
	let mounted;
	let dispose;
	icon = new Component({ props: { icon: "ph:caret-down-bold" } });

	function click_handler() {
		return /*click_handler*/ ctx[5](/*i*/ ctx[8]);
	}

	let if_block = /*activeItem*/ ctx[2] === /*i*/ ctx[8] && create_if_block$1(ctx);
...
class Component$1 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { props: 4, items: 0, heading: 1 });
	}
}
